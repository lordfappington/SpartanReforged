...
| `.MTL` / `MODELS.MTL` | 1 | 5,952 | ordered resource/material declarations | **CONFIRMED binding and TEST/ZBUF/ALPHA controls** | validated R5900 data flow proves child type 2 selects TEST/ZBUF and child type 16 selects ALPHA; PRIM.ABE/order remain open | 3 |
