...
Readiness is **VISUALLY VALIDATED** for LEVEL00 geometry. Descriptor 118 confirms source coordinates/winding and descriptor 5 confirms source V. This does not mean the format is complete: V4-8 semantics, exact MTL sampler/property states, other TIM2 variants, and the literal VU-to-GS dataflow remain unresolved. V4-8 is not required to export positions, topology, material assignment, and usable UVs.
