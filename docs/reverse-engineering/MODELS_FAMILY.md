...
That exporter is validated across the complete LEVEL00 MODELS family. BIN supplies geometry/material IDs, MTL supplies ordered identities/resource references, and AAB supplies static provenance/selection without transforming positions. Descriptor 118 confirms coordinates/winding; descriptor 5 confirms source V and native PSMT4 image linkage. All 30 unique strongly bound geometry TIM2 textures decode exactly against Noesis and assemble into a complete Blender-importable glTF. See [MODELS_EXPORT_PIPELINE.md](MODELS_EXPORT_PIPELINE.md), [MODELS_VISUAL_CONVENTIONS.md](MODELS_VISUAL_CONVENTIONS.md), and [LEVEL00_TEXTURED_RECONSTRUCTION.md](../milestones/LEVEL00_TEXTURED_RECONSTRUCTION.md). Full-scene diagnostics make MTL culling/two-sided and alpha behavior the immediate blockers, followed by sampler semantics, seven unresolved material bindings, and V4-8.
