...
That exporter has now been implemented and validated across the complete LEVEL00 MODELS family. BIN supplies geometry/material IDs, MTL supplies ordered placeholder identities/resource references, and AAB supplies static provenance/selection without transforming positions. See [MODELS_EXPORT_PIPELINE.md](MODELS_EXPORT_PIPELINE.md). The next family blocker is visual convention/material validation rather than geometry reconstruction.
